      ...
      <div className="footer-wrapper">
        <div className="footer-header">
          ...
          <p className="hero-paragraph">
                <span className="medium">LaslesVPN</span>  is a private virtual network that has unique features and has high security.
           </p>
           ...
           <p className="hero-paragraph">
             ©2020Lasles<span className="medium">VPN</span>
           </p>
          </div>
